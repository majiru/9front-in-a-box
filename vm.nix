{
  ...
  source ? fetchurl {
    ...
    hash =
      {
        amd64 = "sha256-bfgHrjDwBLiqfR7IA7ptIys48OqyS3f2NcxAjpwBSRE=";
        arm64 = "sha256-hSxS9WkKDZhCPyFNhilhTmKbzUa2gPIy468zOM176Iw=";
        "386" = "sha256-5jkhEyBS/10sC7UH0iIfAkvHC7w1EpmEG82MO3IvWM8=";
      }
      ."${arch}";
  },
}:
