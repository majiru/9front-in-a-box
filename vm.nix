{
  ...
  source ? fetchurl {
    ...
    hash =
      {
        amd64 = "sha256-Jd7cZNKeeFGav87ezmRwINO8rlep4m+y1ljtymuxttw=";
        arm64 = "sha256-Nt8mirp2tcl+catVeC10lpLXl0KVR5RzH2a9GSXDIcE=";
        "386" = "sha256-ajIosmcmhD6PDwNnSZqpojceeHcWWzn4ofExMxLnpsw=";
      }
      ."${arch}";
  },
}:
