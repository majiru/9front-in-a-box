...
let
  ...
  indypatch = fetchurl {
    url = "https://pastebin.aosc.io/paste/s99mdJMCYWFSvEtOExVAdg/raw";
    hash = "sha256-FgnnJiTcXEBGP4klF6slCI5M0Dl2SVaU0EKMNtswLcg=";
  };
in
stdenv.mkDerivation {
  pname = "mame";
  ...
  src = fetchFromGitHub {
    owner = "mamedev";
    repo = "mame";
    rev = "6678c80e3e7dec477dcddc83a57904445e69ac6a";
    hash = "sha256-+CLxOy7ik+S51cub9tpOPo7iQ5VI2XyMv6gditXeAWI=";
  };
  ...
  makeFlags = [
    ...
    "SOURCES=src/mame/sgi/indy_indigo2.cpp"
    "REGENIE=1"
  ];
